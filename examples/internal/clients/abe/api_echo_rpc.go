...
*/
func (a *EchoRpcApiService) EchoRpcABitOfEverythingServiceEcho(ctx context.Context, value string) (SubStringMessage, *http.Response, error) {
	var (
...
@return SubStringMessage
*/
func (a *EchoRpcApiService) EchoRpcABitOfEverythingServiceEcho2(ctx context.Context, body string) (SubStringMessage, *http.Response, error) {
	var (
...
Description Echo
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EchoRpcApiEchoRpcABitOfEverythingServiceEcho3Opts - Optional Parameters:
     * @param "Value" (optional.String) - 
@return SubStringMessage
*/

type EchoRpcApiEchoRpcABitOfEverythingServiceEcho3Opts struct {
    Value optional.String
}

func (a *EchoRpcApiService) EchoRpcABitOfEverythingServiceEcho3(ctx context.Context, localVarOptionals *EchoRpcApiEchoRpcABitOfEverythingServiceEcho3Opts) (SubStringMessage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
