...
*/
func (a *EchoServiceApiService) EchoServiceEchoServiceEcho(ctx context.Context, id string) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
 ...
 * @param id Id represents the message identifier.
 * @param num
 * @param optional nil or *EchoServiceApiEchoServiceEchoServiceEcho2Opts - Optional Parameters:
...
type EchoServiceApiEchoServiceEchoServiceEcho2Opts struct {
...
func (a *EchoServiceApiService) EchoServiceEchoServiceEcho2(ctx context.Context, id string, num string, localVarOptionals *EchoServiceApiEchoServiceEchoServiceEcho2Opts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
 ...
 * @param num
 * @param lang
 * @param optional nil or *EchoServiceApiEchoServiceEchoServiceEcho3Opts - Optional Parameters:
     * @param "LineNum" (optional.String) - 
     * @param "StatusProgress" (optional.String) - 
     * @param "StatusNote" (optional.String) - 
     * @param "En" (optional.String) - 
...
type EchoServiceApiEchoServiceEchoServiceEcho3Opts struct {
    LineNum optional.String
    StatusProgress optional.String
    StatusNote optional.String
    En optional.String
...
func (a *EchoServiceApiService) EchoServiceEchoServiceEcho3(ctx context.Context, id string, num string, lang string, localVarOptionals *EchoServiceApiEchoServiceEchoServiceEcho3Opts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param lineNum
 * @param statusNote
 * @param optional nil or *EchoServiceApiEchoServiceEchoServiceEcho4Opts - Optional Parameters:
...
type EchoServiceApiEchoServiceEchoServiceEcho4Opts struct {
    Num optional.String
    Lang optional.String
    StatusProgress optional.String
    En optional.String
...
func (a *EchoServiceApiService) EchoServiceEchoServiceEcho4(ctx context.Context, id string, lineNum string, statusNote string, localVarOptionals *EchoServiceApiEchoServiceEchoServiceEcho4Opts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param noNote
 * @param optional nil or *EchoServiceApiEchoServiceEchoServiceEcho5Opts - Optional Parameters:
...
type EchoServiceApiEchoServiceEchoServiceEcho5Opts struct {
    Id optional.String
    Num optional.String
    LineNum optional.String
    Lang optional.String
...
func (a *EchoServiceApiService) EchoServiceEchoServiceEcho5(ctx context.Context, noNote string, localVarOptionals *EchoServiceApiEchoServiceEchoServiceEcho5Opts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ExamplepbSimpleMessage
*/
func (a *EchoServiceApiService) EchoServiceEchoServiceEchoBody(ctx context.Context) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EchoServiceApiEchoServiceEchoServiceEchoDeleteOpts - Optional Parameters:
     * @param "Id" (optional.String) -  Id represents the message identifier.
     * @param "Num" (optional.String) - 
     * @param "LineNum" (optional.String) - 
     * @param "Lang" (optional.String) - 
...
type EchoServiceApiEchoServiceEchoServiceEchoDeleteOpts struct {
    Id optional.String
    Num optional.String
    LineNum optional.String
    Lang optional.String
...
func (a *EchoServiceApiService) EchoServiceEchoServiceEchoDelete(ctx context.Context, localVarOptionals *EchoServiceApiEchoServiceEchoServiceEchoDeleteOpts) (ExamplepbSimpleMessage, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EchoServiceApiEchoServiceEchoServiceEchoPatchOpts - Optional Parameters:
     * @param "UpdateMask" (optional.String) - 
@return ExamplepbDynamicMessageUpdate
*/

type EchoServiceApiEchoServiceEchoServiceEchoPatchOpts struct {
    UpdateMask optional.String
}

func (a *EchoServiceApiService) EchoServiceEchoServiceEchoPatch(ctx context.Context, localVarOptionals *EchoServiceApiEchoServiceEchoServiceEchoPatchOpts) (ExamplepbDynamicMessageUpdate, *http.Response, error) {
	var (
